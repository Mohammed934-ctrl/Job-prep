...
function Navbar() {
  return (
    <nav className="boder-b border-border bg-card/80 sticky top-0 z-50 backdrop-blur-md ">
    ...
    <section>
      <div className="container">
        <div className="text-center">
          <h2 className="text-4xl  sm-text-6xl  font-bold  text-foreground leading-tight mb-3">
            Land your dream job with{" "}
            <span className="bg-linear-to-r from-primary  to-primary/80 bg-clip-text text-transparent text-nowrap">
              AI-powered
            </span>
          </h2>
